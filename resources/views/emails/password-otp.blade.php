            ...
            <table role="presentation" width="100%" style="max-width:560px;background:#ffffff;border-radius:4px;overflow:hidden;border:1px solid #E8E8E8;">
                <tr>
                    <td style="background:#1E3A5F;padding:24px 32px;">
                        <div style="font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#FF8C5A;font-family:Arial,sans-serif;font-weight:700;">Market Eye</div>
                        <div style="margin-top:8px;font-size:24px;color:#ffffff;font-weight:700;">Reset your password</div>
                    </td>
                </tr>
                <tr>
                    <td style="padding:28px 32px;color:#1E3A5F;">
                        <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#6C757D;font-family:Arial,sans-serif;">
                            Use this 6-digit code in the app. It expires in 15 minutes.
                        </p>
